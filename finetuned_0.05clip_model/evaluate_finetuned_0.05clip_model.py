...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Evaluates a finetuned vision-language model on Wikipedia Evaluation Dataset "
    ...
    parser.add_argument("--output", type=str, default="finetuned_0.05_open_clip_results.json",
    ...
    adapter_path = "/Users/maingoclanvy/scale-equity-nlp/finetuned_0.05clip_model/adapter_model.safetensors"
    ...
    # Save the results
    save_group_accuracy(group_accuracies, "finetuned_0.05_open_clip_group_accuracy_results.json")

    # Print the results
    print(f"Model: finetuned_0.05_open_clip")
